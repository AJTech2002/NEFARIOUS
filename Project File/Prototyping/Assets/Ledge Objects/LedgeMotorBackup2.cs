...
public class LedgeMotorBackup2 : MonoBehaviour {
    ...
    private void LateUpdate()
    {
        ...
        else
        {
            ...
            if (pointToBe != lastPointToBe || dismountCreated)
            {
    ...
    private bool jumpedConnection = false;
    ...
    private void ConnectToPoint (Vector3 attachPoint, Vector3 relForw, float sp, Vector3 point)
    {
        if (ledgeController.hasControl)
        {
           ...
           /// ledgeController.ResetPosition(attachPoint, relForw, sp, this, point, dismountCreated);
